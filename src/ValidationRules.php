...
class ValidationRules
{
    ...
    public function MelliCode($attribute, $value, $parameters, $validator)
    {
        ...
        if ( ! preg_match('/^\d{8,10}$/',
                $value) || preg_match('/^[0]{10}|[1]{10}|[2]{10}|[3]{10}|[4]{10}|[5]{10}|[6]{10}|[7]{10}|[8]{10}|[9]{10}$/', $value)) {
            return false;
        }
    ...
    public function Url($attribute, $value, $parameters, $validator)
    {
        ...
        $this->status = (bool) preg_match("/^(HTTP|http(s)?:\/\/(www\.)?[A-Za-z0-9]+([\-\.]{1,2}[A-Za-z0-9]+)*\.[A-Za-z]{2,40}(:[0-9]{1,40})?(\/.*)?)$/",
            $value);
    ...
    public function Domain($attribute, $value, $parameters, $validator)
    {
        ...
        $this->status = (bool) preg_match("/^((www\.)?(\*\.)?[A-Za-z0-9]+([\-\.]{1,2}[A-Za-z0-9]+)*\.[A-Za-z]{2,40}(:[0-9]{1,40})?(\/.*)?)$/",
            $value);
    ...
    public function Address($attribute, $value, $parameters, $validator)
    {
        ...
        $this->status = (bool) preg_match("/^[\pL\s\d\-\/\,\،\.\\\\\x{200c}\x{064b}\x{064d}\x{064c}\x{064e}\x{064f}\x{0650}\x{0651}\x{6F0}-\x{6F9}]+$/u",
            $value);
